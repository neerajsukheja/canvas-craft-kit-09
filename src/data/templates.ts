      ...
      return {
        ...
        sections: [
          ...
          },
          {
            ...
            components: [
              { id: uid(), type: 'icon-card', props: { title: 'Earn a $200 cash rewards bonus', description: 'Plus, earn unlimited 2% cash rewards on purchases with $0 annual fee. Terms apply.', linkText: 'Learn more', icon: 'credit-card' }, layout: L(3) },
              { id: uid(), type: 'icon-card', props: { title: 'New customer? Say hello to a $125 bonus', description: 'Open a Clear Access Banking account, great for students & more, complete offer requirements.', linkText: 'See offer details', icon: 'dollar-sign' }, layout: L(3) },
              { id: uid(), type: 'icon-card', props: { title: 'Open a savings account', description: 'Explore our savings accounts and find the right fit for you.', linkText: 'Get started', icon: 'piggy-bank' }, layout: L(3) },
              { id: uid(), type: 'icon-card', props: { title: 'Interest rates today', description: 'Check current rates for savings, CDs, mortgages and more.', linkText: 'Check rates', icon: 'percent' }, layout: L(3) },
            ],
          },
          {
            id: sid(), name: 'Products & Services', style: '',
            layout: SL({ padding: 'lg', background: 'light', columns: 12, gap: 'md' }),
            components: [
              ...
              { id: uid(), type: 'card', props: { title: 'Active Cash® Card', description: 'Earn unlimited 2% cash rewards on purchases. No annual fee.', cardStyle: 'elevated', icon: 'credit-card' }, layout: L(4) },
              { id: uid(), type: 'card', props: { title: 'Autograph℠ Card', description: 'Earn 3X points on restaurants, travel, gas stations, transit, and more.', cardStyle: 'elevated', icon: 'star' }, layout: L(4) },
              { id: uid(), type: 'card', props: { title: 'Reflect® Card', description: 'Long intro APR period. Take your time to pay down balances.', cardStyle: 'elevated', icon: 'shield' }, layout: L(4) },
            ],
          },
          {
          ...
          },
          {
            ...
            layout: SL({ padding: 'lg', background: 'dark', columns: 12, gap: 'lg' }),
            components: [
              { id: uid(), type: 'list', props: { items: 'Privacy Policy,Terms of Use,Security,Ad Choices', ordered: false, listStyle: 'none' }, layout: L(3) },
              { id: uid(), type: 'list', props: { items: 'Sitemap,Careers,About Wells Fargo,Diversity', ordered: false, listStyle: 'none' }, layout: L(3) },
              { id: uid(), type: 'list', props: { items: 'Investor Relations,Government Relations,Financial Education', ordered: false, listStyle: 'none' }, layout: L(3) },
              { id: uid(), type: 'typography', props: { text: '© 2026 Wells Fargo Bank, N.A. All rights reserved. NMLSR ID 399801', variant: 'caption', align: 'left', color: 'muted', weight: 'normal' }, layout: L(3) },
            ],
          },
        ],
      };
        ...
        sections: [
          ...
          },
          {
            ...
            components: [
              ...
              { id: uid(), type: 'icon-card', props: { title: 'No Monthly Fees', description: 'Keep more of your money with zero monthly maintenance fees on select accounts.', linkText: 'Learn more', icon: 'dollar-sign' }, layout: L(4) },
              { id: uid(), type: 'icon-card', props: { title: '24/7 Support', description: 'Our team is available around the clock to assist you with any question.', linkText: 'Contact us', icon: 'phone' }, layout: L(4) },
              { id: uid(), type: 'icon-card', props: { title: 'Mobile Banking', description: 'Manage your finances anytime, anywhere from your phone or tablet.', linkText: 'Download app', icon: 'globe' }, layout: L(4) },
            ],
          },
          {
            id: sid(), name: 'Testimonials', style: '',
            layout: SL({ padding: 'lg', background: 'light', columns: 12, gap: 'lg' }),
            components: [
              { id: uid(), type: 'typography', props: { text: 'What Our Customers Say', variant: 'h2', align: 'center', color: 'default', weight: 'bold' }, layout: L(12) },
              { id: uid(), type: 'card', props: { title: '"Exceptional Service"', description: 'Wells Fargo made my home buying process smooth and stress-free. Their advisors are incredibly knowledgeable. — Sarah M., Small Business Owner', cardStyle: 'elevated', icon: 'star' }, layout: L(6) },
              { id: uid(), type: 'card', props: { title: '"Made Investing Easy"', description: 'I was new to investing, and their wealth management team guided me every step of the way. — James T., Retiree', cardStyle: 'elevated', icon: 'star' }, layout: L(6) },
            ],
          },
          {
        ...
        sections: [
          ...
          },
          {
            ...
            components: [
              ...
              { id: uid(), type: 'card', props: { title: 'Everyday Checking', description: '$0 monthly fee · Basic features · Mobile banking · Bill pay · Zelle®', cardStyle: 'bordered', icon: 'none' }, layout: L(4) },
              { id: uid(), type: 'card', props: { title: 'Premier Checking', description: '$25/mo (waivable) · All features · Priority support · Rewards · No ATM fees', cardStyle: 'elevated', icon: 'star' }, layout: L(4) },
              { id: uid(), type: 'card', props: { title: 'Private Bank', description: 'Custom pricing · Dedicated advisor · Full investment suite · Concierge', cardStyle: 'bordered', icon: 'briefcase' }, layout: L(4) },
            ],
          },
          {
            id: sid(), name: 'CTA', style: '',
        ...
        sections: [
          ...
          },
          {
            ...
            components: [
              ...
              { id: uid(), type: 'icon-card', props: { title: 'How to Budget Like a Pro', description: 'Master the 50/30/20 rule for effective budgeting and financial freedom.', linkText: 'Read article', icon: 'dollar-sign' }, layout: L(4) },
              { id: uid(), type: 'icon-card', props: { title: 'Understanding Credit Scores', description: 'What factors affect your score and actionable steps to improve it.', linkText: 'Read article', icon: 'trending-up' }, layout: L(4) },
              { id: uid(), type: 'icon-card', props: { title: 'Retirement Planning 101', description: 'It\'s never too early to start. Learn the basics of retirement planning.', linkText: 'Read article', icon: 'briefcase' }, layout: L(4) },
            ],
          },
        ],
      };
      ...
      return {
        ...
        sections: [
          ...
          },
          {
            ...
            layout: SL({ padding: 'lg', background: 'white', columns: 12, gap: 'md' }),
            components: [
              { id: uid(), type: 'card', props: { title: 'Total Balance', description: '$124,532.00', cardStyle: 'elevated', icon: 'dollar-sign' }, layout: L(3) },
              { id: uid(), type: 'card', props: { title: 'Monthly Spending', description: '$3,247.89', cardStyle: 'elevated', icon: 'credit-card' }, layout: L(3) },
              { id: uid(), type: 'card', props: { title: 'Savings Goal', description: '78% Complete', cardStyle: 'elevated', icon: 'trending-up' }, layout: L(3) },
              { id: uid(), type: 'card', props: { title: 'Credit Score', description: '742 — Good', cardStyle: 'elevated', icon: 'shield' }, layout: L(3) },
            ],
          },
          {
